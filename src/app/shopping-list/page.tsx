    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            ...
            <span className="font-semibold text-amber-700">DEMO prices</span>
          </p>
        </div>
      ...
      {recipes.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-slate-300 bg-white p-10 text-center">
          <p className="text-slate-600">No meals on your list yet.</p>
          <Link
            href="/"
              ...
              {recipes.map((r) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="rounded-full bg-white px-2 py-0.5 text-xs font-bold text-slate-500 hover:text-red-600"
                  >
                    ×
                  </button>
                </li>
